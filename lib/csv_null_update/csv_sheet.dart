...
class CsvSheet {
  ...
  CsvSheet(String contents,
    ...
    _fakeColumn = _CsvColumn(this);

    var allRows = contents.split(lineSep);
    var hasHeaderRow = headerRow;
    ...
    if (hasHeaderRow) {
      ...
      for (var index = 1; index < allRowsLength; index++) {
        ...
        //  TODO: Recheck below Null Check
        _contents!.add(tmpRow); //Edited by #lameck
      } // end for loop
    } else {
      // hasHeaderRow
      _row = CsvRow(_headers!, allRows); //TODO: Recheck this file.
      _contents = <List<String>>[];
      var allRowsLength = allRows.length;
      for (var index = 0; index < allRowsLength; index++) {
        ...
        ///TODO: recheck all below code till end of below WHILE LOOP
